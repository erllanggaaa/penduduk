    ...
    <div class="well">
      ...
      <form class="form-signin" method="post" action="../login/proses-login.php">
        <h2 class="form-signin-heading text-center">
          <strong>Sistem Informasi Kelurahan</strong>
        </h2>

        <h4 class="form-signin-heading text-center">Silakan login</h4>

        <input type="text" name="username_warga" class="form-control" placeholder="Username/NIK" autofocus required>

        <input type="password" name="password_warga" class="form-control" placeholder="Password" required>
