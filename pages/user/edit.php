...
<table class="table table-striped table-middle">
  ...
  <tr>
    ...
    <td>
      <select class="form-control selectpicker" name="level_warga" required>
        <option value="<?php echo $data_warga[0]['level_warga'] ?>" selected><?php echo $data_warga[0]['level_warga'] ?></option>
  ...
  <tr>
    <th>Username</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="username_warga" autocomplete="off" value="<?php echo $data_warga[0]['username_warga'] ?>"></td>
  </tr>
  <tr>
    <th>Password</th>
    <td>:</td>
    <td><input type="password" class="form-control" name="password_warga" placeholder="Ubah Password..." required></td>
  </tr>
</table>
