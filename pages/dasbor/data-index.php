...
// hitung warga
$query_warga = "SELECT COUNT(*) AS total FROM warga WHERE level_warga='Warga' AND tampil='Y'";
...
// hitung pengurus
$query_pengurus = "SELECT COUNT(*) AS total FROM pengurus";
$hasil_pengurus = mysqli_query($db, $query_pengurus);
$jumlah_pengurus = mysqli_fetch_assoc($hasil_pengurus);

// hitung warga laki-laki
$query_warga_l = "SELECT COUNT(*) AS total FROM warga WHERE jenis_kelamin_warga = 'L' AND level_warga='Warga' AND tampil='Y'";
$hasil_warga_l = mysqli_query($db, $query_warga_l);
$jumlah_warga_l = mysqli_fetch_assoc($hasil_warga_l);

// hitung warga laki-laki
$query_warga_p = "SELECT COUNT(*) AS total FROM warga WHERE jenis_kelamin_warga = 'P' AND level_warga='Warga' AND tampil='Y'";
...
$query_warga_ld_17 = "SELECT COUNT(*) AS total FROM warga WHERE TIMESTAMPDIFF(YEAR, tanggal_lahir_warga, CURDATE()) >= 17 AND tanggal_lahir_warga != '0000-00-00' AND level_warga='Warga' AND tampil='Y'";
...
$query_warga_kd_17 = "SELECT COUNT(*) AS total FROM warga WHERE TIMESTAMPDIFF(YEAR, tanggal_lahir_warga, CURDATE()) < 17 AND tanggal_lahir_warga != '0000-00-00' AND level_warga='Warga' AND tampil='Y'";
