...
class PDF extends FPDF
{
    ...
    function Header()
    {
      ...
      $this->Image('../../assets/img/logo-depok.jpg',20,10);
        ...
        $this->cell(27,7,'NIK',1,0,'C');
        $this->cell(40,7,'Nama Lengkap',1,0,'C');
        $this->cell(35,7,'Tempat Lhr',1,0,'C');
        $this->cell(20,7,'Tanggal Lhr',1,0,'C');
        $this->cell(8,7,'JK',1,0,'C');
        $this->cell(8,7,'Usia',1,0,'C');
        $this->cell(50,7,'Alamat',1,0,'C');
        $this->cell(7,7,'RT',1,0,'C');
        $this->cell(7,7,'RW',1,0,'C');
        $this->cell(20,7,'Agama',1,0,'C');
        $this->cell(26,7,'Stts Pernikahan',1,0,'C');
        $this->cell(16,7,'Pnddikan',1,0,'C');
        $this->cell(22,7,'Pkrjaan',1,0,'C');
        $this->cell(20,7,'Stts Tinggal',1,1,'C');
...
// ambil dari database
$query = "SELECT *, TIMESTAMPDIFF(YEAR, `tanggal_lahir_warga`, CURDATE()) AS usia_warga FROM warga WHERE tampil='T'";
