...
$nomor = 1;
  ...
  $pdf->Cell(308,8,'DATA ANGGOTA KELUARGA',0,1,'L');
  ...
  $pdf->cell(40,7,'Nama Anggota',1,0,'C');
  $pdf->cell(35,7,'Tempat Lhr',1,0,'C');
  $pdf->cell(20,7,'Tanggal Lhr',1,0,'C');
  $pdf->cell(8,7,'JK',1,0,'C');
  $pdf->cell(50,7,'ALAMAT',1,0,'C');
  $pdf->cell(7,7,'RT',1,0,'C');
  $pdf->cell(7,7,'RW',1,0,'C');
  $pdf->cell(20,7,'AGAMA',1,0,'C');
  $pdf->cell(26,7,'Stts Kawin',1,0,'C');
  $pdf->cell(16,7,'Pnddikan',1,0,'C');
  $pdf->cell(20,7,'Pkrjaan',1,0,'C');
  $pdf->cell(24,7,'Stts Tinggal',1,1,'C');
  ...
  foreach ($data_anggota_keluarga as $anggota_keluarga) {
      ...
      $pdf->cell(27, 7, strtoupper($anggota_keluarga['nik_warga']), 1, 0, 'C');
      ...
      $pdf->cell(50, 7, substr(strtoupper($anggota_keluarga['alamat_warga']), 0, 30), 1, 0, 'L');
