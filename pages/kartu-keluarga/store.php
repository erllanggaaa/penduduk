...
if ($hasil == true) {
  echo "<script>window.alert('Menambah Data Kartu Keluarga Berhasil'); window.location.href='../kartu-keluarga/'</script>";
} else {
  echo "<script>window.alert('Menambah Data Kartu Keluarga Gagal!'); window.location.href='../kartu-keluarga/'</script>";
}
