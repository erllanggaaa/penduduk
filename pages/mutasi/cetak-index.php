...
class PDF extends FPDF
{
    ...
    function Header()
    {
      ...
      $this->Image('../../assets/img/logo-depok.jpg',20,10);
        ...
        $this->cell(27,7,'NIK WARGA',1,0,'C');
        $this->cell(40,7,'NAMA WARGA',1,0,'C');
        $this->cell(35,7,'TEMPAT LAHIR',1,0,'C');
        $this->cell(20,7,'TGL LAHIR',1,0,'C');
        ...
        $this->cell(26,7,'S.PRKAWINAN',1,0,'C');
        $this->cell(16,7,'PDDKAN',1,0,'C');
        $this->cell(34,7,'PEKERJAAN',1,0,'C');
        $this->cell(12,7,'STTUS',1,1,'C');
...
foreach ($data_mutasi as $mutasi) {
    ...
    $pdf->cell(27, 7, strtoupper($mutasi['nik_mutasi']), 1, 0, 'C');
    ...
    $pdf->cell(34, 7, strtoupper($mutasi['pekerjaan_mutasi']), 1, 0, 'C');
    $pdf->cell(12, 7, strtoupper($mutasi['status_mutasi']), 1, 1, 'C');
}
